 ...
 *
 * If a user can log in but does not have a **bound** account in SudoSOS, one will be created and bound (see {@link internal/services!AuthenticationService.LDAPAuthentication | AuthenticationService.LDAPAuthentication}).
