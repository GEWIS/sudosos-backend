 ...
 * @property {Array<InvoiceEntry.model>} invoiceEntries.required - The entries describing this invoice.
 * @property {Array<invoiceStatus.model>} invoiceStatus.required - The status history of the invoice
