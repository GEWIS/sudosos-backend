 ...
 * @property {User} createdBy.required - The user that created the transaction.
 * @property {Array.<SubTransaction>} subTransactions.required - The subTransactions belonging
 * to this transaction.
 * @property {PointOfSaleRevision} pointOfSale.required - The pointOfSale from which the
